...
| File | Description |
| --- | --- |
| `visuals/audit-overview.svg` | Resumen visual del objetivo, severidades, riesgo y cobertura principal de la auditoria. |
| `visuals/fingerprint-map.svg` | Mapa visual de tecnologias, metadatos publicos y superficie descubierta de forma pasiva. |
| `visuals/coverage-matrix.svg` | Matriz visual de modulos agrupados por fase para comprobar cobertura y estados. |
