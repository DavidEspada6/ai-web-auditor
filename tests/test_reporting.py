...
class ReportingTests(unittest.TestCase):
    def test_generate_markdown_report_includes_core_sections(self):
        ...
        self.assertIn("## Audit Dashboard", markdown)
        ...
        self.assertIn("visuals/audit-overview.svg", markdown)
        self.assertIn("## Passive Rule Mapping", markdown)
        self.assertIn("WSTG-CONF-12", markdown)
        self.assertIn("WSTG-INFO-06", markdown)
    ...
    def test_generate_html_report_escapes_content_and_includes_metadata(self):
        ...
        self.assertIn("Audit Dashboard", html)
        self.assertIn("Audit Checklist", html)
        ...
        self.assertIn("Passive Rule Mapping", html)
        self.assertIn("WSTG-CONF-12", html)
